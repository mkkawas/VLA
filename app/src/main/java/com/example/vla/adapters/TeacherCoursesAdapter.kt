...
import com.example.vla.teacher.TeacherCourseView
import com.example.vla.data.DataStorage
import kotlinx.android.synthetic.main.courses_adapter.view.*

class TeacherCoursesAdapter (courses:String): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(s: String) {
            ...
            itemView.setOnClickListener {
                ...
                val i = Intent(it.context, TeacherCourseView::class.java)
                DataStorage.courseSelected = s
